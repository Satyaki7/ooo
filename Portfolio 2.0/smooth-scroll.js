...
(function() {
    function C() {
        if (!D && document.body) {
            ...
            if (top != self) v = !0;
                ...
                w = function() {
                    h ||
                        (h = setTimeout(function() { e.style.height = "0";
    ...
    function ha(a) { if (a) { l.length || (l = [a, a, a]);
            a = Math.abs(a);
            l.push(a);
            l.shift();
            clearTimeout(Z);
            Z = setTimeout(function() { try { localStorage.SS_deltaBuffer = l.join(",") } catch (a) {} }, 1E3); var b = 120 < a && K(a),
                b = !K(120) && !K(100) && !b; return 50 > a ? !0 : b } }

    function x(a, b) { return Math.floor(a / b) == a / b }

    function K(a) { return x(l[0], a) && x(l[1], a) && x(l[2], a) }
    ...
    var aa = { frameRate: 150, animationTime: 400, stepSize: 100, pulseAlgorithm: !0, pulseScale: 4, pulseNormalize: 1, accelerationDelta: 50, accelerationMax: 3, keyboardSupport: !0, arrowScroll: 50, fixedBackground: !0, excluded: "" },
        ...
        H = {},
        V, A = {};
    if (window.localStorage && localStorage.SS_deltaBuffer) try { l = localStorage.SS_deltaBuffer.split(",") } catch (la) {}
    var Q = function() { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(a, b, d) { window.setTimeout(a, d || 1E3 / 60) } }(),
        ...
        g = (G || u || ka) && !ja,
        ba = !1;
    try { window.addEventListener("test", null, Object.defineProperty({}, "passive", { get: function() { ba = !0 } })) } catch (ma) {}
